...
const gpio_num_t PIN_NUM_VSYNC = GPIO_NUM_41;
const gpio_num_t PIN_NUM_DE = GPIO_NUM_40; 
const gpio_num_t PIN_NUM_PCLK = GPIO_NUM_0;

const gpio_num_t PIN_NUM_DATA0 = GPIO_NUM_8;  // B0
const gpio_num_t PIN_NUM_DATA1 = GPIO_NUM_3;   // B1
const gpio_num_t PIN_NUM_DATA2 = GPIO_NUM_46;   // B2
const gpio_num_t PIN_NUM_DATA3 = GPIO_NUM_9;   // B3
const gpio_num_t PIN_NUM_DATA4 = GPIO_NUM_1;   // B4

const gpio_num_t PIN_NUM_DATA5 = GPIO_NUM_5;   // G0
const gpio_num_t PIN_NUM_DATA6 = GPIO_NUM_6;  // G1
const gpio_num_t PIN_NUM_DATA7 = GPIO_NUM_7;   // G2
const gpio_num_t PIN_NUM_DATA8 = GPIO_NUM_15;   // G3
const gpio_num_t PIN_NUM_DATA9 = GPIO_NUM_16;  // G4
const gpio_num_t PIN_NUM_DATA10 = GPIO_NUM_4;  // G5

const gpio_num_t PIN_NUM_DATA11 = GPIO_NUM_45; // R0
const gpio_num_t PIN_NUM_DATA12 = GPIO_NUM_48; // R1
const gpio_num_t PIN_NUM_DATA13 = GPIO_NUM_47; // R2
const gpio_num_t PIN_NUM_DATA14 = GPIO_NUM_21; // R3
const gpio_num_t PIN_NUM_DATA15 = GPIO_NUM_14; // R4
